        ...
        <div class="">
                ...
                <table>
                    ...
                    <h2>Servicios adicionales <br>
                        con clientes</h2>
                <table>
                            <td> En la veterinaria, nos importa mucho la comunicacion con nuestros clientes por eso tenemos atencion virtual <br>por medio de WhatsApp, Gmail y tambien tenemos servicio de recordatorio por medio de un mensaje SMS donde se le recordara sobre su agendamiento</td>
                                <td>
                                    <img src="max.png" alt="expopet colombia"><br>
                                Hola comoe stas esto es una prubea
                            </td>
