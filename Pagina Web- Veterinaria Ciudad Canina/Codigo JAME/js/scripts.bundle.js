    ...
    return {
        ...
        block: function(target, options) {
            ...
            var params = {
                ...
                css: {
                    top: (options.css ? (options.css.top ? options.css.top : '30%' )  : '30%'),
                    left: '50%',
                    border: '0',
                    padding: '0',
...
var KTPortlet = function(elementId, options) {
    ...
    var defaultOptions = {
        ...
        tools: {
            toggle: {
                collapse: __('Colapsar'),
                expand: __('Expandir')
            },
            reload: __('Recargar'),
            remove: __('Eliminar'),
            fullscreen: {
                on: __('Pantalla completa'),
                off: __('Salir pantalla completa')
            }
        },
        sticky: {
            offset: 300,
